...
@Autonomous(name="Auto Test de la IMU", group="Linear Opmode")
public class IMUAuto extends LinearOpMode {
    ...
    static final double     COUNTS_PER_MOTOR_REV    = DriveConstants.TICKS_PER_REV;   // eg: GoBILDA 312 RPM Yellow Jacket
    static final double     DRIVE_GEAR_REDUCTION    = DriveConstants.GEAR_RATIO;     // No External Gearing.
    static final double     WHEEL_DIAMETER_INCHES   = DriveConstants.WHEEL_RADIUS ;     // For figuring circumference
    static final double     COUNTS_PER_INCH         = DriveConstants.TICKS_PER_INCH;
   ...
   // MotorizedArmSubsystem m_motorArm;
    //ServoedArmSubsystem m_servoArm;
    //ingleServoClaw m_singleClaw;
    ...
    public void runOpMode()
    {
       ...
       // m_motorArm = new MotorizedArmSubsystem(hardwareMap);
        //m_singleClaw = new SingleServoClaw(hardwareMap);
        //m_servoArm = new ServoedArmSubsystem(hardwareMap);

        waitForStart();

        driveStraight(0.5, -50, 0);
    }
